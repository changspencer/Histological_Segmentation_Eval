...
Sourced from the https://github.com/GatorSense/EZUNET repo
"""
...
class PrmiUNet(nn.Module):
    ...
    def __init__(self, num_classes, in_channels=3, depth=4, start_filts=64):
        """
        Arguments:
            ...
            start_filts: int, number of convolutional filters in the first encoder block. start 64
        """
        super(PrmiUNet, self).__init__()
        ...
        for i in range(depth):
            if i == 0:
                temp_in_channels = self.n_channels
            else:
        ...
        for k in range(depth-1):
            ...
            #temp_out_channels = temp_in_channels
            #temp_in_channels = temp_in_channels / 2
